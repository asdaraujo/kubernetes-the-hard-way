...
logmsg "Deploy the coredns cluster add-on:"
...
logmsg "List the pods created by the kube-dns deployment:"

kubectl get pods -l k8s-app=kube-dns -n kube-system

## Verification

logmsg "Create a busybox deployment:"
...
logmsg "Retrieve the full name of the busybox pod:"

POD_NAME=$(kubectl get pods -l run=busybox -o jsonpath="{.items[0].metadata.name}")

logmsg "Execute a DNS lookup for the kubernetes service inside the busybox pod:"

kubectl exec -ti $POD_NAME -- nslookup kubernetes || true
